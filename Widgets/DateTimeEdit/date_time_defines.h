...
namespace DateTime
{
    ...
    const QString JANUARY_TEXT = QStringLiteral("1月");
    const QString FEBRUARY_TEXT = QStringLiteral("2月");
    const QString MARCH_TEXT = QStringLiteral("3月");
    const QString APRIL_TEXT = QStringLiteral("4月");
    const QString MAY_TEXT = QStringLiteral("5月");
    const QString JUNE_TEXT = QStringLiteral("6月");
    const QString JULY_TEXT = QStringLiteral("7月");
    const QString AUGUST_TEXT = QStringLiteral("8月");
    const QString SEPTEMBER_TEXT = QStringLiteral("9月");
    const QString OCTOBER_TEXT = QStringLiteral("10月");
    const QString NOVEMBER_TEXT = QStringLiteral("11月");
    const QString DECEMBER_TEXT = QStringLiteral("12月");
